						...
						<div style="Z-INDEX: -111" id="EntryTableDiv" runat="server">
							...
							<TABLE id="entryTable" border="0" cellSpacing="0" cellPadding="2">
								<TR id="rowNBF_BENNAME" class="TRow_Normal">
									...
									<TD style="HEIGHT: 23px" id="ctlddlCRL_RELEATIOCD" width="186"><SHMA:DROPDOWNLIST id="ddlCRL_RELEATIOCD" tabIndex="2" runat="server" Width="13.0pc" DataValueField="CRL_RELEATIOCD" onkeydown="return cancelBack()"
