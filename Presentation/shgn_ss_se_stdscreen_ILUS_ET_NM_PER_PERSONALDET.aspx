    ...
    <div>
        ...
        <div id="NormalEntryTableDiv" class="NormalEntryTableDiv" runat="server" style="z-index: -111">
                ...
                <tr id="rowddlCOP_OCCUPATICD" class="TRow_Alt">
                    ...
                    <td id="ctlddlCOP_OCCUPATICD" width="186">
                        ...
                        <input class="BUTTON" title="Open Occupation List Of Values" tabindex="8" onclick="openOccupationDialog();"
                            value=".." type="button" name="ProposalLov ">
                        <div class="alert" style="display: none; overflow: scroll; height: 150px; width: 150%"
                            id="div_alert">
                            <table>
                                <tr>
                                    <td>
            ...
            <tr class="TRow_Alt">
                ...
                <td style="height: 21px" width="186">
                    <SHMA:DropDownList ID="ddlNPH_INSUREDTYPE" TabIndex="26" runat="server" CssClass="RequiredField"
            ...
            <tr>
                ...
                <td width="186">
                    <asp:CompareValidator ID="cfvNPH_INSUREDTYPE" runat="server" Display="Dynamic" ErrorMessage="String Format is Incorrect "
                        ControlToValidate="ddlNPH_INSUREDTYPE" EnableClientScript="False" Type="String"
                        Operator="DataTypeCheck"></asp:CompareValidator>
                    <asp:RequiredFieldValidator ID="rfvNPH_INSUREDTYPE" runat="server" Display="Dynamic"
                        ErrorMessage="Required" ControlToValidate="ddlNPH_INSUREDTYPE"></asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr id="rowNPH_INSUREDTYPE" class="TRow_Alt">
                <td id="TDddlNPH_INSUREDTYPE" width="110" align="right">
                </td>
                <td width="186">
                    <p>
        ...
        <script language="javascript">
            ...
            function setViewSecondLife(val) {
                ...
                if (val == 'N') {
                    ...
                    parent.document.getElementById('shgn_ss_se_stdscreen_ILUS_ET_NM_PER_PERSONALDETINS').height = 410; //135
...
//        document.getElementById("ddlCOP_OCCUPATICD").addEventListener("keydown", function(event){
